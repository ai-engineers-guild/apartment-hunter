...
The author of this open-source project provides the code "AS IS" without warranty of any kind. The author assumes no responsibility or liability for how this tool is used by third parties.

## 4. User Responsibility
By using this software, you agree that you are solely responsible for your actions. You must comply with the local laws, the Terms of Service (ToS), and the `robots.txt` policies of any third-party websites you interact with. You agree not to use this tool in a manner that causes unreasonable load on third-party servers (e.g., DDoS).
